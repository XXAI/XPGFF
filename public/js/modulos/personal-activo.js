...
function actualizarRegistros(){
    ...
    $.get('api/personal-activo', parametros, function(data){
        ...
        for(var i in data['paginado'].data){
            ...
            registros += "<tr><td>"+elemento.puesto+"</td><td>"+elemento.rama+"</td><td>"+elemento.profesion+"</td><td>"+elemento.tipo_nomina+"</td><td>"+elemento.programa+"</td><td>"+elemento.fuente+"</td><td class='text-center'>"+elemento.total_personas.format()+"</td><td class='text-center'>$"+elemento.total_percepcion.format(2)+"</td></tr>";

            total_personas += elemento.total_personas;
            total_percepcion += elemento.total_percepcion;
        }
        registros += "<tr><th class='text-right' colspan='6'>Totales: </th><th class='text-center'>"+total_personas.format()+"</th><th class='text-center'>$"+total_percepcion.format(2)+"</th></tr>";
