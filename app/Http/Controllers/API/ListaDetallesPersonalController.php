...
class ListaDetallesPersonalController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $lista_detalles = Personal::select('personal_instituto.id','activo','comision_sindical','personal_instituto.rfc','personal_instituto.curp','personal_instituto.nombre','catalogo_puesto.descripcion as puesto', 'catalogo_rama.descripcion as rama','catalogo_profesion.descripcion as profesion','personal_instituto.clues','personal_instituto.proporcionado_por')
